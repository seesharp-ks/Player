...
{
    /// <summary>
    /// Логика взаимодействия для MWVert.xaml
    /// </summary>
    public partial class MWVert : Window
    {
        public MWVert()
        {
            InitializeComponent();
        ...
        {
            if (MWVertical.WindowStyle == WindowStyle.SingleBorderWindow)
            {
                MWVertical.WindowStyle = WindowStyle.None;
                MWVertical.WindowState = WindowState.Maximized;
                MWVertical.ResizeMode = ResizeMode.NoResize; //https://tinyurl.com/fullscrwpf
                Player.Stretch = System.Windows.Media.Stretch.Fill;
            }
            else
            {
                Player.Stretch = System.Windows.Media.Stretch.Uniform;
                MWVertical.WindowStyle = WindowStyle.SingleBorderWindow;
                MWVertical.WindowState = WindowState.Normal;
                MWVertical.ResizeMode = ResizeMode.CanResize;
            }
        }
    }
}
